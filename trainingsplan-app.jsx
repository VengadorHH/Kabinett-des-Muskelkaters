...
const SymbolKnopf = ({ onClick, titel, children }) => (
    ...
    <div className="b min-h-screen" style={{ background: C.beton, color: C.tinte }}>
      ...
      <main className="px-4 py-4 pb-24 max-w-xl mx-auto">
        {laden ? <p className="m text-sm" style={{ color: C.grau }}>Lade …</p>
          ...
          : tab === "plaene" ? <Plaene plaene={plaene} bearbeiten={setOffen} kopieren={planKopieren} verlauf={verlauf} merkliste={merkliste} vormerken={vormerken} merkWeg={merkWeg}
...
function Plaene({ plaene, bearbeiten, kopieren, vorlage, sicherung, einspielen, verlauf, merkliste, vormerken, merkWeg }) {
            ...
            <li key={p.id}><Karte>
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex gap-1 shrink-0">
                  <SymbolKnopf onClick={() => kopieren(p)} titel="Plan als Vorlage kopieren"><Kopie /></SymbolKnopf>
