...
const ausKatalog = (k, typ) => ({
  id: uid(), name: k.name, geraet: k.geraet || "", seiten: k.seiten || "beid", messung: "wdh",
    ...
    <Karte>
      ...
      <div className="flex items-center justify-between mt-2">
        <span className="m text-[11px] uppercase" style={{ color: C.grau }}>
          {b.typ === "leiter" ? "Leiter" : b.typ === "intervall" ? "Intervall" : b.typ === "einzel" ? "Einzelsätze" : b.typ === "einfach" ? "Zirkel / Warm-up" : b.typ === "laufband" ? "Laufband" : b.typ === "amrap" ? "AMRAP" : "Sätze"}
        </span>
