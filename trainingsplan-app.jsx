...
const vorlageKettlebell = () => ({
  ...
  bloecke: [
    { id: uid(), typ: "standard", name: "Warm-up", auswerten: false, uebungen: [
      ...
      { id: uid(), name: "Arm- & Schulterkreisen", geraet: "Körpergewicht", messung: "zeit", saetze: 2, dauer: 30, wdh: 0, kg: 0, pause: 0, muskeln: m({ schulter: 100 }) },
      { id: uid(), name: "World's Greatest Stretch", geraet: "Matte", messung: "wdh", saetze: 2, wdh: 5, dauer: 0, kg: 0, pause: 0, muskeln: m({ beine: 60, core: 40 }) },
      { id: uid(), name: "Deep Squat to Hamstring", geraet: "Körpergewicht", messung: "wdh", saetze: 1, wdh: 10, dauer: 0, kg: 0, pause: 0, muskeln: m({ beine: 100 }) },
      { id: uid(), name: "Bird Dog", geraet: "Matte", messung: "wdh", saetze: 2, wdh: 10, dauer: 0, kg: 0, pause: 0, muskeln: m({ core: 80, ruecken: 20 }) },
    ]},
...
const katalogStart = () => [
  ...
  ["Bird Dog", "Matte", 0, 10, { core: 80, ruecken: 20 }],
...
/* ============ Editor ============ */
function Editor({ plan, sichern: save, zurueck, weg, katalog, katalogSichern }) {
